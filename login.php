    ...
    <body class="hold-transition login-page  login-img">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <h3 style=" text-align: center; "> <img src="images/<?php echo $data1['foto'] ?>" width="100" height="90" alt=""></h3>

                <h3 style="color: black; font-size: 17px;  text-align: center;"> <b><?php echo $data1['nama_isp'] ?></b></h3>
                <p style="color: black; font-size: 18px;" class="login-box-msg">SYSTEM TAGIHAN GADINGNET</p>
                <p style="color: black; font-size: 10px;" class="login-box-msg"><b>Silahkan Login Mengunakan User dan password yang telah admin berikan</b> </p>
