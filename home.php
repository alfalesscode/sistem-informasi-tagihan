      ...
      <div class="row">
          <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-blue">
                  <div class="inner">
                      ...
                      <p><b>Pamasukan Hari Ini</p></b>
                  </div>
                  <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                  </div>
                  <a href="?page=kas" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6">
          ...
          <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                  <div class="inner">
                      <h3><?php $pengguna_sistem = mysqli_query($koneksi, "select * from tb_user"); ?></h3>
                      <h3 class="counter"><?php echo mysqli_num_rows($pengguna_sistem); ?></h3>
                      <p><b>Pengguna Sistem</p></b>
                  </div>
                  <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                  </div>
                  <a href="?page=pengguna" class="small-box-footer">More info <i
          ...
          <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                  <div class="inner">
                      <h3><?php $paket_inet = mysqli_query($koneksi, "select * from tb_paket"); ?></h3>
                      <h3 class="counter"><?php echo mysqli_num_rows($paket_inet); ?></h3>
                      <p><b>Data Paket Internet</p></b>
                  </div>
                  <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                  </div>
          ...
          <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                  <div class="inner">
                      <h3><?php $pelanggan = mysqli_query($koneksi, "select * from tb_pelanggan"); ?></h3>
                      <h3 class="counter"><?php echo mysqli_num_rows($pelanggan); ?></h3>
                      <p><b>Data Pelanggan</p></b>
                  </div>
                  <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                  </div>
          ...
          <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                  <div class="inner">
                      <h3><?php $tagihan = mysqli_query($koneksi, "select * from tb_tagihan"); ?></h3>
                      <h3 class="counter"><?php echo mysqli_num_rows($tagihan); ?></h3>
                      <p><b>Data Tagihan</p></b>
                  </div>
                  <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                  </div>
                  ...
                  <div class="box box-primary box-solid">
                   ...
                   ?>
                                      ...
                                      <tr>
                                          ...
                                          <td style="color: <?php echo $color ?>"><?php echo $data['nama_pelanggan'] ?>
                                          </td>
                                          <td style="color: <?php echo $color ?>"><?php echo $data['nama_paket'] ?></td>
                                          <td style="color: <?php echo $color ?>">
                                              <?php echo $bulan ?>/<?php echo $tahun ?> </td>
                                          <td style="color: <?php echo $color ?>">
                                          ...
                                          <td>
                                              ...
                                              <a href="#" disabled="" class="btn btn-info btn-sm" title=""><i
                                          ...
                                          <td>
                                              <a target="blank"
                                                  ...
                                                  class="btn btn-info btn-sm" title=""><i class="fa fa-money"></i> Cetak
                                                  Bukti Bayar</a>
                                          </td>
