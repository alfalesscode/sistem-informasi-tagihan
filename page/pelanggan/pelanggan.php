            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="example1">
                        ...
                        <button type="button" class="btn btn-info" style="margin-bottom: 10px;" data-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" type="button" class="btn btn-info" data-toggle="modal"
                                            data-target="#mymodal<?php echo $data['id_pelanggan']; ?>"><i
                                                class="fa fa-edit"></i> Ubah</a>

                                        <a onclick="return confirm('Apakah Anda Yakin Mengahpus Data Ini')"
                                            href="?page=pelanggan&aksi=hapus&id=<?php echo $data['id_pelanggan'] ;?>"
                                            class="btn btn-danger" title=""><i class="fa fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                                            ...
                                            <div class="box box-primary box-solid">
                                                <div class="box-header with-border">
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span></button> Ubah Data Pelanggan
                                                </div>
                                                ...
                                                <form role="form" method="POST">
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" name="id_pelanggan"
                                                            value="<?php echo $data1['id_pelanggan']; ?>">

                                                        <div class="form-group">
                                                            <label>Nama Pelanggan</label>
                                                            <input type="text" name="nama" class="form-control"
                                                                value="<?php echo $data1['nama_pelanggan']; ?>" required="">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="no_telp" class="form-control"
                                                                value="<?php echo $data1['no_telp']; ?>" required="">
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" name="simpan"
                                                                class="btn btn-block btn-primary btn-lg">Simpan</button>
                                                        </div>
                                                    <?php } ?>
                                                </form>
                                            </div>
                            ...
                            <form role="form" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control"
                                        value="<?php echo $data1['password']; ?>" required="">
                                </div>
