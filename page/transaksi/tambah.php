 <form method="POST">
     <div class="col-md-12">
         ...
         <div class="col-md-1">
             <div class="form-group">
                 <button type="submit" name="filter" style="margin-top: 45px;" class="btn btn-primary"><i
                         class="fa fa-plus"></i> Buat Form</button>
             </div>
         ...
         <div class="box box-primary box-solid">
             ...
             <form method="POST">
                   ...
                   ?>
                         ...
                         <tr>
                             ...
                             <input type="hidden" class="form-control" name="id_pelanggan[]"
                                 value="<?php echo $id_pelanggan ?>" readonly>
                             <input type="hidden" class="form-control" name="bulan2[]"
                                 value="<?php echo $bulantahun; ?>" readonly>
                             </td>
                             <td><?php echo $data['nama_pelanggan'] ?></td>
                             <td><?php echo $data['nama_paket'] ?></td>
                             <td><input style="width: 100px" type="text" class="form-control uang" name="harga[]"
                                     readonly="" value="<?php echo $data['harga'] ?>"></td>
                         </tr>
                ...
                ?>
                 ...
                 <button type="submit" name="simpan" style="margin-top: 10px;" class="btn btn-success">Simpan
                     Tagihan</button>
