...
<table width="100%">
    <tr>
        ...
        <td style="font-size: 20px;">
            <div align="center"><strong>BUKTI PEMBAYARAN <br> <?php echo $data['nama_bayar'] ?></strong></div>
        </td>
    </tr>
    ...
    <tr>
        <td width="0">&nbsp;</td>
        <td>
            <div align="center">Tanggal Bayar:
            <?php echo tglIndonesia(date('d F Y', strtotime($data2['tgl_bayar']))); ?></div>
        </td>
    </tr>
...
<div style=" margin-left: 30px; text-align: center;">
    Terima kasih Telah Melakukan Pembayaran, Simpan Struk Sebagai Bukti pembayaran
    <br><br><?php echo $data1['nama_sekolah']; ?>
