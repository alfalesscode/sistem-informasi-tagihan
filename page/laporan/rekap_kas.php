...
<table>
  <table width="100%" >
    <tr>
      <td width="0">&nbsp;</td>
      <td colspan="6"><div align="center"><strong> LAPORAN KAS MASUK DAN KELUAR <br> Tgl <?php echo  tglIndonesia2(date('d F Y', strtotime($tgl_awal))) ?> s/d Tgl <?php echo  tglIndonesia2(date('d F Y', strtotime($tgl_akhir))) ?> </strong></div></td>
    </tr>
  </table><br>
</table><br>
